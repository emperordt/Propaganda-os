...
Run AFTER `propaganda-os-migration.sql`. Adds the `icps` table for customer avatar profiles + Schwartz awareness analysis.

Paste into Supabase SQL Editor: https://wqclspynbdghfsosqygg.supabase.co/project/_/sql
